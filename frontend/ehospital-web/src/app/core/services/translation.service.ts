  ...
  private getEnglishTranslations(): Translations {
    return {
      ...
      integrations: {
        ...
        labSystem: 'Lab System (HL7/FHIR)',
        labSystemDesc: 'Connect with external laboratory systems using HL7 or FHIR protocols',
        insurancePortal: 'Insurance Portal',
        insurancePortalDesc: 'Integrate with insurance providers for eligibility checks and claim submission',
        paymentGateway: 'Payment Gateway',
        paymentGatewayDesc: 'Process payments through secure payment gateways',
        emailService: 'Email Service',
        emailServiceDesc: 'Send email notifications to patients and staff',
        smsService: 'SMS Service',
        smsServiceDesc: 'Send SMS notifications and reminders',
        name: 'Name',
        enabled: 'Enabled',
